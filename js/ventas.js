...
function cargarMarcasMovil(){
  ...
  lista.innerHTML=marcas.map(m=>{
    ...
    background:var(--P);color:#fff;"><div style="display:flex;align-items:center;gap:10px"><span style="font-size:16px;font-weight:700">${m}</span>${badge}</div><span id="pm-chevron-${key}" style="color:#fff;font-size:20px;font-weight:300">›</span>
  }).join('');
}
